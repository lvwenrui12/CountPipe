...
namespace CountPipe
{
    public partial class ErodeFrm : Form
    {
        ...
        private void btnOk_Click(object sender, EventArgs e)
        {
            try
            {
                if (parentForm.rawImg != null)
                {
                    ...
                    Mat dilateImg;
                    pictrueHelper.Erode(parentForm.rawImg, element,out dilateImg);
        ...
        private void ErodeFrm_FormClosed(object sender, FormClosedEventArgs e)
        {
            parentForm.Enabled = true;
        }
    }
