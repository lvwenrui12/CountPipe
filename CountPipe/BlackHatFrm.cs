...
namespace CountPipe
{
    public partial class BlackHatFrm : Form
    {
        ...
        private void btnOk_Click(object sender, EventArgs e)
        {
            try
            {
                if (parentForm.rawImg != null)
                {
                    ...
                    Mat tophatImg;
                    pictrueHelper.MorphologyEx(parentForm.rawImg, element, MorphTypes.BlackHat,out tophatImg);
                    parentForm.pictrueHelper.showPic(tophatImg);
            ...
            {
                log.Error("tophatImg fail " + ex.Message);
