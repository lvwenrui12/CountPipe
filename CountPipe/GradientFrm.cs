...
namespace CountPipe
{
    public partial class GradientFrm : Form
    {
        ...
        private void btnOk_Click(object sender, EventArgs e)
        {
            try
            {
                if (parentForm.rawImg != null)
                {
                    ...
                    Mat dilateImg;
                    pictrueHelper.MorphologyEx(parentForm.rawImg, element, MorphTypes.Gradient,out dilateImg);
        ...
        private void GradientFrm_FormClosed(object sender, FormClosedEventArgs e)
        {
            parentForm.Enabled = true;
        }
    }
